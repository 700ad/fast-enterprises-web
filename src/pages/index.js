      ...
      <div className=" z-10 absolute w-screen h-screen inset-0 bottom-0 text-white ">
        <div className="container h-screen flex flex-col items-start justify-end p-8 md:pb-32 mx-auto">
          <h1 className="text-4xl md:text-6xl font-extralight">
            The global destination for your audit,
            <br className="hidden md:block" />
            tax and consulting needs.
          </h1>
            ...
            <div className="md:col-span-8 col-span-1 flex items-center justify-center bg-white h-screen">
              <div className=" w-7/12 flex flex-col items-start justify-start">
                ...
                <p className="mt-8 text-xl opacity-80">
                  At capital 45 we have a wealth of experience in developing
                  stand-alone and integrated AI solutions developed by PHD
                  experts.
                </p>
                <p className="mt-8">
                  We not only offer development, but also the guidance and
          ...
          <div className="grid grid-cols-1 md:grid-cols-12">
            <div className="md:col-span-8 col-span-1 flex items-center justify-center bg-white h-screen">
              <div className=" w-7/12 flex flex-col items-start justify-start">
                <p className=" text-blue-800 text-xl">Where finance meets AI</p>
                <h2 className="text-3xl mt-8">
                  We’re focused on keeping ahead of the curve
                </h2>
                <p className="mt-8 text-xl opacity-80">
                  We build AI for different applications from building deep
                  neural networks which learn trading patterns, natural language
                  processing for sentiment analysis to fraud detection and
                  credit applications.
                </p>
                <p className="mt-8">
                  Partner with us, talk to our team{" "}
